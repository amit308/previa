...
@Component({
  selector: 'app-pending-quote',
  templateUrl: './pending-quote.component.html',
  styleUrls: ['./pending-quote.component.scss']
})
...
// cancelTest(data){
//   this.healthService.cancelPatientTest(data).subscribe((res=>{
//     console.log("=========cancelPateintsTest",res);
    
//   }))
// }

    // Angular material needs component in order to show poppup
    /* openDialog(): void {
