...
@Component({
  selector: 'app-rajected-quote',
  templateUrl: './rajected-quote.component.html',
  styleUrls: ['./rajected-quote.component.scss']
})
export class RajectedQuoteComponent implements OnInit {
